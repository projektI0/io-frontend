...
import {addList, removeList, renameList, setCurrentList} from "../store/listsSlice";
            ...
            <ul className={"w-2/4"}>
                {shoppingLists.map((list, index) => {
                    return (<li key={list}
                            ...
                            <div>
                                <button className={`bg-primary text-white rounded-md px-4 py-2 m-1 ${index !== activeListIndex ? "opacity-75" : ""}`}

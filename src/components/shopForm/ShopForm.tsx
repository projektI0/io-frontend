...
const ShopForm = () => {  
    ...
    return (
        (showPopup && response) ? 
          ...
          ( 
            <div className="w-4/6 md:w-1/2 lg:w-1/3 mx-auto my-6 border-secondary border-2 rounded-md font-body text-xs lg:text-lg text-primary">
              <form
              ...
              >
                ...
                <div className="w-1/2 md:w-1/3 mx-auto mt-2 bg-primary text-gray-100 text-center rounded-md border-2 hover:text-primary hover:bg-white hover:border-primary hover:border-2">
                  <button
